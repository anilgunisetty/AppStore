...
class AppStore extends Component {
  ...
  render() {
    ...
    const filterAppList = this.getFilterAppList(activeTabId)

    const filterAppLists = filterAppList.filter(each =>
